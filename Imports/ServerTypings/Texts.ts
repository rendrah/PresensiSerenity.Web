namespace PresensiSerenity.Texts {
    ...
    declare namespace Db {
        ...
        namespace Master {
            ...
            namespace Jurusan {
                export const IdJurusan: string;
                export const NamaJurusan: string;
            }

            namespace Kelas {
                export const IdKelas: string;
                export const JurusanId: string;
                export const JurusanNamaJurusan: string;
                export const NamaKelas: string;
                export const SiswaDetail: string;
            }
            ...
            namespace Siswa {
                ...
                export const KelasJurusanId: string;
                export const KelasNamaKelas: string;
                export const Nama: string;
