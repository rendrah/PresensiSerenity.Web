...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Master
        {
            ...
            {
                public const string JurusanIndex = "~/Modules/Master/Jurusan/JurusanIndex.cshtml";
            }

            public static class Kelas
            {
                public const string KelasIndex = "~/Modules/Master/Kelas/KelasIndex.cshtml";
            }

            public static class Siswa
            {
                public const string SiswaIndex = "~/Modules/Master/Siswa/SiswaIndex.cshtml";
            }
